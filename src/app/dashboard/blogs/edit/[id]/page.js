...
export default function EditBlog({ params }) {
  ...
  useEffect(() => {
    const fetchBlog = async () => {
      try {
        ...
        setExistingCoverImageUrl(blog.coverImageUrl || "");
        ...
        setError("Failed to load blog. It may have been deleted.");
      } finally {
        setLoading(false);
      }
    };
  ...
  const handleRemoveExistingImage = () => {
    setDeletedCoverImageUrl(existingCoverImageUrl);
    ...
    <div className="max-w-4xl mx-auto">
      <div className="flex items-center mb-8">
        ...
        <div>
          ...
          <p className="text-gray-500 mt-1">Update your engineering insight or technical guide</p>
        </div>
      </div>
            ...
            <div className="border-2 border-dashed border-gray-300 rounded-xl p-6 bg-gray-50">
              ...
              {existingCoverImageUrl && (
                <div className="mb-4">
                  ...
                  <div className="flex justify-between items-center bg-white border border-gray-200 py-2 px-3 rounded text-sm font-medium text-gray-700">
                    <span className="truncate mr-2 text-xs">{existingCoverImageUrl.substring(0, 40)}...</span>
                    <button type="button" onClick={handleRemoveExistingImage} className="text-gray-400 hover:text-red-600">
                      <Trash2 size={16} />
                    </button>
                  </div>
                </div>
              ...
              {coverImageFile && (
                <div className="mb-4">
                  ...
                  <div className="flex justify-between items-center bg-blue-50 border border-blue-100 py-2 px-3 rounded text-sm font-medium text-blue-700">
                    <span className="truncate mr-2 text-xs">{coverImageFile.name}</span>
                    <button type="button" onClick={handleRemoveNewImage} className="text-blue-400 hover:text-blue-600">
                      <Trash2 size={16} />
                    </button>
                  </div>
                </div>
